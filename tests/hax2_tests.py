...
from azoth.hax2 import item, place, plane, pragma, rules, terrain, terrainmap, weapon
import unittest
...
class PutOnMap(Default):
    ...
    def test_impassable_occupant(self):
        ...
        assert_raises(rules.Occupied, self.hax2.put_on_map, o2, self.plane, 0, 0)
...
class MoveOnMap(Default):
    ...
    def test_impassable_terrain(self):
        ...
        assert_raises(rules.Impassable, self.hax2.move_on_map, self.obj, 'east')
    ...
    def test_occupant(self):
        ...
        assert_raises(rules.Occupied, self.hax2.move_on_map, o1, 'east')
        assert_at(o1, self.plane, 0, 0)
...
class MoveFromMapToBag(Default):
    ...
    def test_full(self):
        ...
        self.hax2.move_from_map_to_bag(self.obj, self.bag)
        raises_(rules.WontFitError, self.hax2.move_from_map_to_bag, obj2,
                self.bag)
